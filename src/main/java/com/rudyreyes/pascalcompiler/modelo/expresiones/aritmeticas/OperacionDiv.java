 ...
 * @author rudyo
 */
public class OperacionDiv extends Instruccion{
    
    
    private Instruccion operando1;
    private Instruccion operando2;
    
     public OperacionDiv(Instruccion operando1, Instruccion operando2, int linea, int columna) {
    ...
    public Object dividir(Object op1, Object op2){
        ...
        switch (tipo1) {
            ...
            default -> {
                return new Errores("SEMANTICO", "Division erronea (DIV): la operacion "+op1.toString()+" no se puede dividir con la operacion "+op2.toString(), this.linea, this.columna);
