 ...
 * @author rudyo
 */
public class EstructuraTipos extends Instruccion{
    
    LinkedList<Instruccion> instrucciones;

    public EstructuraTipos(LinkedList<Instruccion> instrucciones, int linea, int columna) {
    ...
    public String generarast(Arbol arbol, String anterior) {
        ...
        cadena += strConst + "[label=\"CREACION TIPOS\"];\n";
        cadena += instrucci + "[label=\"DECLARACIONES TIPOS\"];\n";
